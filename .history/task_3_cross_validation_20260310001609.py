...
def evaluate_results(actual_class_list: list[pd.Series], predicted_class_list: list[pd.Series],
    ...
    results['avg_macro_precision'] / number_of_folds
    results['avg_macro_recall'] / number_of_folds
    results['avg_macro_f_measure'] / number_of_folds
    results['avg_weighted_precision'] / number_of_folds
    results['avg_weighted_recall'] / number_of_folds
    results['avg_weighted_f_measure'] / number_of_folds
    results['avg_standard_accuracy'] / number_of_folds
    results['avg_balanced_accuracy'] / number_of_folds
