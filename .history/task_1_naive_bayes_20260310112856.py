...
class NaiveBayes:
    ...
    def train_model(self, training_data: pd.DataFrame):
        ...
        for class_value in self.class_info[1]:
            ...
            class_prob = self.retrieve_class_probability(class_value)
            for feature_name in self.feature_info:
                ...
                for feature_value in self.feature_info[feature_name]:
                    ...
                    feature_prob = count / class_count
                    self.conditional_probabilities[(class_value, feature_name, feature_value)] = (feature_prob + 1) / (class_prob + (1 * feature_counts)) if class_count > 0 else 0
