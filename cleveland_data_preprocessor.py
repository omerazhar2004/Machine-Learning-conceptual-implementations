...
# Yes, this file is ugly. It is meant to be. You will be fixing it for a different portfolio! Right now, just leave it
# as it is ;)
...
# Discretises the chosen columns using the DecisionTreeDiscretiser. Yes, the resulting columsn still show
...
# Handles missing data in the cleveland dataset. In this case, it simply drops rows containing missing entries.
